...
export default function Navbar() {
    return (
        <nav className="flex opacity-0 hover:opacity-100 items-center justify-center">
            <div className={"p-4 text-lg flex items-center justify-center gap-8 text-index-blue-dark dark:text-index-blue-light "}>
